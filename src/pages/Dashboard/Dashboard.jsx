    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-4 md:p-8">
      <div className="max-w-4xl mx-auto">
            ...
            <div className="flex gap-2">
              {['all', 'pending', 'completed'].map((f) => (
                <button
                  key={f}
                  onClick={() => setFilter(f)}
                  className={`px-4 py-2.5 rounded-lg font-medium transition-all duration-200 ${filter === f 
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <button
                      ...
                      className={`mt-1 w-6 h-6 rounded-full border-2 flex items-center justify-center transition-all duration-200 ${todo.completed 
                      ...
                      {editingId === todo._id ? (
                        ...
                        <>
                          ...
                          <div className="flex items-center gap-4 mt-2">
                            <span className={`px-3 py-1 rounded-full text-xs font-medium ${todo.completed 
        ...
        <div className="mt-8 text-center text-gray-500 text-sm">
          <p>Made with ❤️ • {new Date().getFullYear()} Todo App</p>
        </div>
      </div>
    </div>
  )
