...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true)
    try {
      const res = await axios.post('https://todo-backend-api-livid.vercel.app/api/auth/register', {
        ...
        <div className="bg-slate-900/80 backdrop-blur-lg rounded-2xl p-8 shadow-[0_15px_30px_rgba(0,0,0,0.5)] border border-slate-700">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="relative">
              ...
              />
              <label className="absolute left-0 -top-1 text-slate-400 text-sm">Full Name</label>
            </div>
            ...
            <div className="relative">
              <input
                ...
                className="peer w-full bg-transparent border-b-2 border-slate-600 py-2 text-white placeholder-transparent focus:outline-none focus:border-blue-400 transition-all duration-300"
              />
              <label className="absolute left-0 -top-1 text-slate-400 text-sm">Email</label>
            </div>
            ...
            <div className="relative">
              <input
                ...
                className="peer w-full bg-transparent border-b-2 border-slate-600 py-2 text-white placeholder-transparent focus:outline-none focus:border-blue-400 transition-all duration-300"
              />
              <label className="absolute left-0 -top-1 text-slate-400 text-sm">Password</label>
            </div>
